...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "file_type",
            sa.Enum("csv", "json", name="import_file_type", create_type=False),
            nullable=False,
            server_default="csv",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "schema_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("import_schemas.id", onupdate="CASCADE", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "job_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("import_jobs.id", ondelete="CASCADE", onupdate="CASCADE"),
            nullable=False,
        ),
