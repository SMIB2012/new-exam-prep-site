...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "mode",
            sa.Enum("TUTOR", "EXAM", name="session_mode", create_type=False),
            nullable=False,
            server_default="TUTOR",
        ),
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "SUBMITTED", "EXPIRED", name="session_status", create_type=False),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "session_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("test_sessions.id", ondelete="CASCADE", onupdate="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column(
            "question_version_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("question_versions.id", onupdate="CASCADE"),
            nullable=True,
        ),
