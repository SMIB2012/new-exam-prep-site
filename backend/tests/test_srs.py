...
class TestRatingMapper:
    ...
    def test_correct_slow_is_hard(self):
        ...
        rating = map_attempt_to_rating(
            correct=True,
            time_spent_ms=100000  # 100 seconds
        )
        assert rating == 2
    ...
    def test_correct_fast_confident_is_easy(self):
        ...
        rating = map_attempt_to_rating(
            correct=True,
            time_spent_ms=10000,  # 10 seconds
            change_count=0
        )
        assert rating == 4
...
class TestSRSIntegration:
    ...
    def test_telemetry_features_affect_rating(self):
        ...
        rating_easy = map_attempt_to_rating(
            correct=True,
            time_spent_ms=10000,
            change_count=0
        )
        ...
        rating_hard = map_attempt_to_rating(
            correct=True,
    ...
    def test_retrievability_in_range(self):
        ...
        for _ in range(20):
            for rating in [1, 2, 3, 4]:
                ...
                assert 0 <= retrievability <= 1, f"Retrievability must be in [0,1], got {retrievability}"
