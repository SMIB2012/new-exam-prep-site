...
export default function ReviewPage() {
  ...
  useEffect(() => {
    studentAPI.getReview(sessionId)
      .then(setReview)
      .catch(console.error)
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-bold mt-4">Session Review</h1>
      </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {isCorrect && <Badge variant="success" className="ml-auto">Correct Answer</Badge>}
